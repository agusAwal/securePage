...
WebUI.click(findTestObject('Object Repository/landingPage/btn-debit'))

WebUI.click(findTestObject('Object Repository/landingPage/btn-lanjutkan'))

WebUI.waitForElementPresent(findTestObject('Object Repository/landingPage/assertObjDebit'), 50)

WebUI.verifyTextPresent('Kartu Debit', false)

WebUI.setText(findTestObject('Object Repository/landingPage/inpt-cardNo'), '4111111111111111')
...
WebUI.setText(findTestObject('Object Repository/landingPage/inpt-ccvNo'), '123')
